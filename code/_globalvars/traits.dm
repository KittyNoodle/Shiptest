...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_CYTHRXIMMUNE" = TRAIT_CYTHRXIMMUNE, //Archonic Edit
		"TRAIT_ANOMALY_IMMUNE_AIMTIACRYSTAL" = TRAIT_ANOMALY_IMMUNE_AIMTIACRYSTAL, //Archonic Edit
		"TRAIT_ARCHONICIST" = TRAIT_ARCHONICIST, //Archonic Edit
		"TRAIT_APOTHEOTIC" = TRAIT_APOTHEOTIC, //Archonic Edit
		"TRAIT_OVERIC" = TRAIT_OVERIC, //Archonic Edit
